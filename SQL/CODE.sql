create database assingment_work;
use assingment_work;
...
CREATE TABLE departments (
    department_id INT (1) PRIMARY KEY,
...
CREATE TABLE dependents (
    dependent_id INT (1) PRIMARY KEY,
...
alter table employees add column commission int(10);
update employees set commission  = (salary/3) where department_id in ( 2,8,9);
update employees set commission  = 0 where department_id in (1,3,4,5,6,7,10,11);
update employees set manager_name = first_name where employee_id = manager_id ;
select * from countries ;

alter table employees add column bonus int(10);
update employees set  bonus = 0 where department_id in ( 2,8,9);
update employees set bonus  = (salary/3) where department_id in (1,3,4,5,6,7,10,11);
